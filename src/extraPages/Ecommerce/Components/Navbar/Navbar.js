...
import { userSelector , signout } from '../../../../redux/reducer/UserReducer';
import { filterActions } from '../../../../redux/reducer/FilterReducers';
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg" style={{backgroundColor : '#e3f2fd'}}>
        <div className="container-fluid">
            <Link  className="navbar-brand" to="">EZSHOP</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                {location.pathname === '/ecommerce' && <form className="d-flex" role="search" style={{marginRight:"20rem"}}>
