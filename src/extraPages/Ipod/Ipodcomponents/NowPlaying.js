...
//                     <img className={styleNow.banner} src={data[current].images} alt="banner" />
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className={styleNow.now}>
                    <img className={styleNow.banner} src={data[current].images} alt="banner" />
                    <div className={styleNow.scrollContainer}>
                        <b className={styleNow.marqueeText}>{data[current].name}</b>
                    </div>
                </div>
                <div className={styleNow.barContainer}>
                    <p className={styleNow.leftPara}>{audio !== null ? Math.floor(audio.currentTime) : "0 / 0"}</p>
