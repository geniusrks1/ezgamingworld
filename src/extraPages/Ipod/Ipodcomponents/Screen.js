...
import wallpaper from './assets/images/love.jpg'
    ...
    return (
        <>
            <div className={screenStyle.screenContainer}>
                ...
                <div className={screenStyle.nav}><span className={screenStyle.time}>{time}</span><img className={screenStyle.battery} src={battery} alt="battery" /></div>
                ...
                <img className={screenStyle.wallpaper} src={wallpaper} alt="screen style"/>
