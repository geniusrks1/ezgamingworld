...
//     onUpdateTodo({
//       ...todo,
//       title: title.trim() || todo.title // If empty, retain previous title
//     });
//     setEditing(false);
//   };
...
//           />
//           <button onClick={handleSave}  className={styles.edit_button}>Save</button>
//         </div>
//       ) : (
//         <div>
//           <div>{todo.title}</div>
//           <button onClick={handleEdit} className={styles.edit_button}>Edit</button>
//           <button onClick={handleDelete} className={styles.delete_button}>Delete</button>
//         </div>
//       )}
//     </div>
//   );
